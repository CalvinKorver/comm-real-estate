...
789 Oak Dr,Testburg,54321,WA,Jane Smith,(555) 987-6543,jane.smith@example.com,321 Owner Blvd,Owner Town,WA,11111`;
    ...
    expect(responseData.summary.createdProperties + responseData.summary.mergedProperties).toBe(2);
    expect(responseData.summary.createdOwners + responseData.summary.mergedOwners).toBe(2);
