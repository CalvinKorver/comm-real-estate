...
const MarketingPage = () => {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      if (errorData.message === "This email is already subscribed to our newsletter.") {
        console.error('Email already subscribed:', errorData.message);
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2">
              ...
              <h2 className="mt-6 text-2xl text-gray-600">
                Design your perfect run. <br /> Sync to your watch. <br /> Start
                moving.
              </h2>
              <div className="mt-8">
                <form
                ...
                {submitted && (
                  <Alert className="mt-4 bg-green-50 text-green-800 border-green-200">
                    <AlertDescription>
                      Thanks for signing up! We'll notify you when Run Sync
                      launches.
                    </AlertDescription>
                  </Alert>
                )}
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="bg-white p-8 rounded-xl shadow">
              ...
              <p className="text-gray-600">
                Design structured workouts with warmup, main sets, and cooldown
                blocks.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow">
              ...
              <p className="text-gray-600">
                Set target paces for each segment of your run to hit your goals.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow">
              <h3 className="text-xl text-black font-semibold mb-4">
              ...
              <p className="text-gray-600">
                Seamlessly sync workouts to your Apple Watch and track your
                progress.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          ...
          <div className=" text-center text-gray-400">
            <p>&copy; 2025 Pace Kit. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
