...
async function main() {
  ...
  const [contacts, notes, images, coords, properties, orphanOwners] =
  ...
  console.log(
    `Deleted: ${contacts.count} contacts, ${notes.count} notes, ${images.count} images, ${coords.count} coordinates, ${properties.count} properties, ${orphanOwners.count} orphan owners.`
  )
}
