...
export default function SignUpPage() {
  ...
  async function onSubmit(values: SignUpFormValues) {
    ...
    try {
      ...
      if (result?.error) {
        setServerError("Registration successful, but failed to sign in automatically");
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input autoComplete="given-name" placeholder="First name" {...field} disabled={isLoading} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input autoComplete="family-name" placeholder="Last name" {...field} disabled={isLoading} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="password" autoComplete="new-password" placeholder="Password (min. 8 characters)" {...field} disabled={isLoading} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="password" autoComplete="new-password" placeholder="Confirm password" {...field} disabled={isLoading} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <div className="text-center text-sm text-muted-foreground">
          ...
          <Link href="/auth/signin" className="font-medium text-emerald-700 hover:text-emerald-600">
            Sign in
          </Link>
        </div>
      </div>
