      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>This card should have proper background and text colors</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-foreground">Input Test</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border rounded-lg bg-card text-card-foreground">
            ...
            <p className="text-muted-foreground">This should have card background</p>
          </div>
          ...
          <div className="p-4 border rounded-lg bg-popover text-popover-foreground">
            ...
            <p className="text-muted-foreground">This should have popover background</p>
          </div>
        </div>
