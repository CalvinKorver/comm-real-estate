...
export default function MapZoomControls({
  ...
  const handleFitAllProperties = () => {
    ...
    const totalLat = propertiesWithCoordinates.reduce((sum, property) => 
      sum + property.coordinates!.latitude, 0)
    const totalLng = propertiesWithCoordinates.reduce((sum, property) => 
      sum + property.coordinates!.longitude, 0)
